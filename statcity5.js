...
async function getCurrentConditions() {
  const endpoint = new URL(
    "https://dataservice.accuweather.com/currentconditions/v1/55489?apikey=Qc1ej31WWglKsRnGyRNbRjA5atq9ei1H"
  );
...
async function getHourly() {
  const hourlyEndpoint = new URL(
    "https://dataservice.accuweather.com/forecasts/v1/hourly/12hour/55489?apikey=Qc1ej31WWglKsRnGyRNbRjA5atq9ei1H&metric=true"
  );
